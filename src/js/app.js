...
var app = new Framework7({
  ...
  data : function(){
    return {
      ...
      datelog:{},      
      config :{
      mainServer: 'https://ptab-vps.com/pdam/integrasi/',//https://ptab-vps.com/pdam-test/integrasi/
      imageServer:'https://ptab-vps.com/pdam',//https://ptab-vps.com/pdam-test
      pulsaServer: 'https://ptab-vps.com/pdam/mobilepulsa/',//https://ptab-vps.com/pdam-test/mobilepulsa/
      offdataServer: 'https://ptab-vps.com/pdam/data/',//https://ptab-vps.com/pdam-test/data/
       },
       scanStatus:false,
       localProduct:[], 
       basket:[],
