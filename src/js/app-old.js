...
var app = new Framework7({
  ...
  data : function(){
    return {
      ...
      datelog:{},      
      config :{
      mainServer: 'https://ctm.tab-jdol.com/pdam/integrasi/',//https://ptab-vps.com/pdam-test/integrasi/
      imageServer:'https://ctm.tab-jdol.com/pdam',//https://ptab-vps.com/pdam-test
      pulsaServer: 'https://ctm.tab-jdol.com/pdam/mobilepulsa/',//https://ptab-vps.com/pdam-test/mobilepulsa/
      offdataServer: 'https://ctm.tab-jdol.com/pdam/data/',//https://ptab-vps.com/pdam-test/data/ 
       },
       scanStatus:false,
       localProduct:[], 
       basket:[],
